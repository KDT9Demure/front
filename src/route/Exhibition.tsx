                    ...
                    <div className={styles.imgBox}>
                        ...
                        <div className={styles.additionalDiv} style={{ left: 280, top: 75 }}>
                            <div className={styles.DivInInfo} >
                                ...
                                <div className={styles.PP}> {productPrice(8)}<span className={styles.won}> 원</span></div>
                            </div>
                        ...
                        <div className={styles.additionalDiv} style={{ right: 170, top: 20 }}>
                            <div className={styles.DivInInfo} >
                                ...
                                <div className={styles.PP}> {productPrice(4)}<span className={styles.won}> 원</span></div>
                            </div>
                            <div className={styles.DivInShape}>
                                <div className={styles.icon}><FontAwesomeIcon icon={faChevronRight} /></div>
                            </div>
                        ...
                        <div className={styles.additionalDiv} style={{ right: 500, top: 220 }}>
                            <div className={styles.DivInInfo} >
                                ...
                                <div className={styles.PP}> {productPrice(3)}<span className={styles.won}> 원</span></div>
                            </div>
                            <div className={styles.DivInShape}>
                                <div className={styles.icon}><FontAwesomeIcon icon={faChevronRight} /></div>
                            </div>
                        ...
                        <div className={styles.additionalDiv} style={{ right: 700, top: 170 }}>
                            <div className={styles.DivInInfo} >
                                ...
                                <div className={styles.PP}> {productPrice(2)}<span className={styles.won}> 원</span></div>
                            </div>
                            <div className={styles.DivInShape}>
                                <div className={styles.icon}><FontAwesomeIcon icon={faChevronRight} /></div>
                            </div>
                        ...
                        <div className={styles.gradient} >
                            <div className={styles.mainTitle}>나만의 가장 완벽한 크리스마스</div>
                            <div className={styles.mainText}> 우리 집에서 열리는 화려한 북유럽의 크리스마스 마켓!
